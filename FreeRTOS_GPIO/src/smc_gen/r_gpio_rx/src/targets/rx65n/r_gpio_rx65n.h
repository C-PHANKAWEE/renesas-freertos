...
* Description  : Specifics for the r_gpio_rx driver for the RX65N.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#include "platform.h"
#if defined(BSP_MCU_RX65N)  /* Prevents the compiler from finding multiple definitions of constant in this file. */
...
#define GPIO_DSCR_IS_SUPPORTED    /* High-drive is supported for the RX65N */
#define GPIO_DSCR2_IS_SUPPORTED   /* High-speed interface high-drive is supported for the RX65N */
