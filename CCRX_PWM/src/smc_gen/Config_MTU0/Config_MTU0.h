...
Macro definitions
***********************************************************************************************************************/
#define MTU0_PCLK_COUNTER_DIVISION      (2)
#define _BB7F_TGRA0_VALUE               (0xBB7FU) /* TGRA0 value */
#define _EA5F_TGRB0_VALUE               (0xEA5FU) /* TGRB0 value */
#define _8C9F_TGRC0_VALUE               (0x8C9FU) /* TGRC0 value */
